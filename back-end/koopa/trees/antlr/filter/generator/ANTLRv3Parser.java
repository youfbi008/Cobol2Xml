// $ANTLR 3.1.1 back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g 2014-02-26 01:14:27
...
public class ANTLRv3Parser extends Parser {
    ...
    public String getGrammarFileName() { return "back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g"; }
    ...
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:90:1: grammarDef : ( DOC_COMMENT )? ( 'lexer' | 'parser' | 'tree' | ) g= 'grammar' id ';' ( optionsSpec )? ( tokensSpec )? ( attrScope )* ( action )* ( rule )+ EOF -> ^( id ( DOC_COMMENT )? ( optionsSpec )? ( tokensSpec )? ( attrScope )* ( action )* ( rule )+ ) ;
    public final ANTLRv3Parser.grammarDef_return grammarDef() throws RecognitionException {
        ...
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:91:5: ( ( DOC_COMMENT )? ( 'lexer' | 'parser' | 'tree' | ) g= 'grammar' id ';' ( optionsSpec )? ( tokensSpec )? ( attrScope )* ( action )* ( rule )+ EOF -> ^( id ( DOC_COMMENT )? ( optionsSpec )? ( tokensSpec )? ( attrScope )* ( action )* ( rule )+ ) )
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:91:9: ( DOC_COMMENT )? ( 'lexer' | 'parser' | 'tree' | ) g= 'grammar' id ';' ( optionsSpec )? ( tokensSpec )? ( attrScope )* ( action )* ( rule )+ EOF
            {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:91:9: ( DOC_COMMENT )?
            int alt1=2;
            ...
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:92:6: ( 'lexer' | 'parser' | 'tree' | )
            int alt2=4;
            switch ( input.LA(1) ) {
            case 65:
                {
            ...
            switch (alt2) {
                case 1 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:92:8: 'lexer'
                    {
                    ...
                    break;
                case 2 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:93:10: 'parser'
                    {
                    ...
                    break;
                case 3 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:94:10: 'tree'
                    {
                    ...
                    break;
                case 4 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:95:14: 
                    {
                    if ( state.backtracking==0 ) {
            ...
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:97:25: ( optionsSpec )?
            int alt3=2;
            ...
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:97:38: ( tokensSpec )?
            int alt4=2;
            ...
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:97:50: ( attrScope )*
            loop5:
            do {
                int alt5=2;
            ...
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:97:61: ( action )*
            loop6:
            do {
                int alt6=2;
            ...
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:98:6: ( rule )+
            int cnt7=0;
            loop7:
            do {
                int alt7=2;
            ...
            // AST REWRITE
            // elements: action, rule, attrScope, tokensSpec, DOC_COMMENT, id, optionsSpec
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
            ...
            {
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:100:9: ^( id ( DOC_COMMENT )? ( optionsSpec )? ( tokensSpec )? ( attrScope )* ( action )* ( rule )+ )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
                root_1 = (CommonTree)adaptor.becomeRoot(adaptor.create(gtype,g), root_1);

                adaptor.addChild(root_1, stream_id.nextTree());
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:101:12: ( DOC_COMMENT )?
                if ( stream_DOC_COMMENT.hasNext() ) {
                    adaptor.addChild(root_1, stream_DOC_COMMENT.nextNode());

                }
                stream_DOC_COMMENT.reset();
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:101:25: ( optionsSpec )?
                if ( stream_optionsSpec.hasNext() ) {
                    adaptor.addChild(root_1, stream_optionsSpec.nextTree());

                }
                stream_optionsSpec.reset();
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:101:38: ( tokensSpec )?
                if ( stream_tokensSpec.hasNext() ) {
                    adaptor.addChild(root_1, stream_tokensSpec.nextTree());

                }
                stream_tokensSpec.reset();
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:101:50: ( attrScope )*
                while ( stream_attrScope.hasNext() ) {
                    adaptor.addChild(root_1, stream_attrScope.nextTree());

                }
                stream_attrScope.reset();
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:101:61: ( action )*
    ...
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:105:1: tokensSpec : TOKENS ( tokenSpec )+ '}' -> ^( TOKENS ( tokenSpec )+ ) ;
    public final ANTLRv3Parser.tokensSpec_return tokensSpec() throws RecognitionException {
        ...
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:106:2: ( TOKENS ( tokenSpec )+ '}' -> ^( TOKENS ( tokenSpec )+ ) )
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:106:4: TOKENS ( tokenSpec )+ '}'
            {
            ...
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:106:11: ( tokenSpec )+
            int cnt8=0;
            loop8:
            do {
                int alt8=2;
            ...
            {
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:106:29: ^( TOKENS ( tokenSpec )+ )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
    ...
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:109:1: tokenSpec : TOKEN_REF ( '=' (lit= STRING_LITERAL | lit= CHAR_LITERAL ) -> ^( '=' TOKEN_REF $lit) | -> TOKEN_REF ) ';' ;
    public final ANTLRv3Parser.tokenSpec_return tokenSpec() throws RecognitionException {
        ...
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:110:2: ( TOKEN_REF ( '=' (lit= STRING_LITERAL | lit= CHAR_LITERAL ) -> ^( '=' TOKEN_REF $lit) | -> TOKEN_REF ) ';' )
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:110:4: TOKEN_REF ( '=' (lit= STRING_LITERAL | lit= CHAR_LITERAL ) -> ^( '=' TOKEN_REF $lit) | -> TOKEN_REF ) ';'
            {
            ...
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:111:3: ( '=' (lit= STRING_LITERAL | lit= CHAR_LITERAL ) -> ^( '=' TOKEN_REF $lit) | -> TOKEN_REF )
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:111:5: '=' (lit= STRING_LITERAL | lit= CHAR_LITERAL )
                    {
                    ...
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:111:9: (lit= STRING_LITERAL | lit= CHAR_LITERAL )
                    int alt9=2;
                    ...
                    switch (alt9) {
                        case 1 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:111:10: lit= STRING_LITERAL
                            {
                            ...
                            break;
                        case 2 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:111:29: lit= CHAR_LITERAL
                            {
                    ...
                    {
                        // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:111:50: ^( '=' TOKEN_REF $lit)
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:112:16: 
                    {
    ...
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:117:1: attrScope : 'scope' id ACTION -> ^( 'scope' id ACTION ) ;
    public final ANTLRv3Parser.attrScope_return attrScope() throws RecognitionException {
        ...
        RewriteRuleSubtreeStream stream_id=new RewriteRuleSubtreeStream(adaptor,"rule id");
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:118:2: ( 'scope' id ACTION -> ^( 'scope' id ACTION ) )
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:118:4: 'scope' id ACTION
            {
            ...
            {
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:118:25: ^( 'scope' id ACTION )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
    ...
    // $ANTLR start "action"
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:121:1: action : '@' ( actionScopeName '::' )? id ACTION -> ^( '@' ( actionScopeName )? id ACTION ) ;
    public final ANTLRv3Parser.action_return action() throws RecognitionException {
        ...
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:123:2: ( '@' ( actionScopeName '::' )? id ACTION -> ^( '@' ( actionScopeName )? id ACTION ) )
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:123:4: '@' ( actionScopeName '::' )? id ACTION
            {
            ...
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:123:8: ( actionScopeName '::' )?
            int alt11=2;
            switch ( input.LA(1) ) {
                case TOKEN_REF:
                    {
            ...
            switch (alt11) {
                case 1 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:123:9: actionScopeName '::'
                    {
            ...
            // AST REWRITE
            // elements: actionScopeName, ACTION, 72, id
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
            ...
            {
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:123:45: ^( '@' ( actionScopeName )? id ACTION )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
                root_1 = (CommonTree)adaptor.becomeRoot(stream_72.nextNode(), root_1);

                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:123:51: ( actionScopeName )?
    ...
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:126:1: actionScopeName : ( id | l= 'lexer' -> ID[$l] | p= 'parser' -> ID[$p] );
    public final ANTLRv3Parser.actionScopeName_return actionScopeName() throws RecognitionException {
        ...
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:130:2: ( id | l= 'lexer' -> ID[$l] | p= 'parser' -> ID[$p] )
            int alt12=3;
            switch ( input.LA(1) ) {
            case TOKEN_REF:
            case RULE_REF:
            ...
            switch (alt12) {
                case 1 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:130:4: id
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:131:4: l= 'lexer'
                    {
                    ...
                    break;
                case 3 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:132:9: p= 'parser'
                    {
    ...
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:135:1: optionsSpec : OPTIONS ( option ';' )+ '}' -> ^( OPTIONS ( option )+ ) ;
    public final ANTLRv3Parser.optionsSpec_return optionsSpec() throws RecognitionException {
        ...
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:136:2: ( OPTIONS ( option ';' )+ '}' -> ^( OPTIONS ( option )+ ) )
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:136:4: OPTIONS ( option ';' )+ '}'
            {
            ...
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:136:12: ( option ';' )+
            int cnt13=0;
            loop13:
            do {
                int alt13=2;
                ...
                switch (alt13) {
            	case 1 :
            	    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:136:13: option ';'
            	    {
            ...
            {
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:136:33: ^( OPTIONS ( option )+ )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
    ...
    // $ANTLR start "option"
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:139:1: option : id '=' optionValue -> ^( '=' id optionValue ) ;
    public final ANTLRv3Parser.option_return option() throws RecognitionException {
        ...
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:140:5: ( id '=' optionValue -> ^( '=' id optionValue ) )
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:140:9: id '=' optionValue
            {
            ...
            {
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:140:31: ^( '=' id optionValue )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
                root_1 = (CommonTree)adaptor.becomeRoot(stream_71.nextNode(), root_1);
    ...
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:143:1: optionValue : ( id | STRING_LITERAL | CHAR_LITERAL | INT | s= '*' -> STRING_LITERAL[$s] );
    public final ANTLRv3Parser.optionValue_return optionValue() throws RecognitionException {
        ...
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:144:5: ( id | STRING_LITERAL | CHAR_LITERAL | INT | s= '*' -> STRING_LITERAL[$s] )
            int alt14=5;
            switch ( input.LA(1) ) {
            case TOKEN_REF:
            case RULE_REF:
            ...
            switch (alt14) {
                case 1 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:144:9: id
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:145:9: STRING_LITERAL
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 3 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:146:9: CHAR_LITERAL
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 4 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:147:9: INT
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 5 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:148:7: s= '*'
                    {
    ...
    public final ANTLRv3Parser.rule_return rule() throws RecognitionException {
        ...
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:155:2: ( ( DOC_COMMENT )? (modifier= ( 'protected' | 'public' | 'private' | 'fragment' ) )? id ( '!' )? (arg= ARG_ACTION )? ( 'returns' rt= ARG_ACTION )? ( throwsSpec )? ( optionsSpec )? ( ruleScopeSpec )? ( ruleAction )* ':' altList ';' ( exceptionGroup )? -> ^( RULE id ( ^( ARG $arg) )? ( ^( RET $rt) )? ( optionsSpec )? ( ruleScopeSpec )? ( ruleAction )* altList ( exceptionGroup )? EOR[\"EOR\"] ) )
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:155:4: ( DOC_COMMENT )? (modifier= ( 'protected' | 'public' | 'private' | 'fragment' ) )? id ( '!' )? (arg= ARG_ACTION )? ( 'returns' rt= ARG_ACTION )? ( throwsSpec )? ( optionsSpec )? ( ruleScopeSpec )? ( ruleAction )* ':' altList ';' ( exceptionGroup )?
            {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:155:4: ( DOC_COMMENT )?
            int alt15=2;
            ...
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:156:3: (modifier= ( 'protected' | 'public' | 'private' | 'fragment' ) )?
            int alt17=2;
            ...
            switch (alt17) {
                case 1 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:156:5: modifier= ( 'protected' | 'public' | 'private' | 'fragment' )
                    {
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:156:14: ( 'protected' | 'public' | 'private' | 'fragment' )
                    int alt16=4;
                    switch ( input.LA(1) ) {
                    case 75:
                        {
                    ...
                    switch (alt16) {
                        case 1 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:156:15: 'protected'
                            {
                            ...
                            break;
                        case 2 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:156:27: 'public'
                            {
                            ...
                            break;
                        case 3 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:156:36: 'private'
                            {
                            ...
                            break;
                        case 4 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:156:46: 'fragment'
                            {
            ...
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:158:3: ( '!' )?
            int alt18=2;
            ...
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:159:3: (arg= ARG_ACTION )?
            int alt19=2;
            ...
            switch (alt19) {
                case 1 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:159:5: arg= ARG_ACTION
                    {
            ...
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:160:3: ( 'returns' rt= ARG_ACTION )?
            int alt20=2;
            ...
            switch (alt20) {
                case 1 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:160:5: 'returns' rt= ARG_ACTION
                    {
            ...
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:161:3: ( throwsSpec )?
            int alt21=2;
            ...
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:161:15: ( optionsSpec )?
            int alt22=2;
            ...
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:161:28: ( ruleScopeSpec )?
            int alt23=2;
            ...
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:161:43: ( ruleAction )*
            loop24:
            do {
                int alt24=2;
            ...
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:163:3: ( exceptionGroup )?
            int alt25=2;
            ...
            // AST REWRITE
            // elements: id, ruleScopeSpec, arg, altList, exceptionGroup, optionsSpec, ruleAction, rt
            // token labels: arg, rt
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
            ...
            {
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:164:9: ^( RULE id ( ^( ARG $arg) )? ( ^( RET $rt) )? ( optionsSpec )? ( ruleScopeSpec )? ( ruleAction )* altList ( exceptionGroup )? EOR[\"EOR\"] )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
                ...
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:164:67: ( ^( ARG $arg) )?
                ...
                stream_arg.reset();
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:164:80: ( ^( RET $rt) )?
                ...
                stream_rt.reset();
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:165:9: ( optionsSpec )?
                if ( stream_optionsSpec.hasNext() ) {
                    adaptor.addChild(root_1, stream_optionsSpec.nextTree());

                }
                stream_optionsSpec.reset();
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:165:22: ( ruleScopeSpec )?
                if ( stream_ruleScopeSpec.hasNext() ) {
                    adaptor.addChild(root_1, stream_ruleScopeSpec.nextTree());

                }
                stream_ruleScopeSpec.reset();
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:165:37: ( ruleAction )*
                ...
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:167:9: ( exceptionGroup )?
    ...
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:172:1: ruleAction : '@' id ACTION -> ^( '@' id ACTION ) ;
    public final ANTLRv3Parser.ruleAction_return ruleAction() throws RecognitionException {
        ...
        RewriteRuleSubtreeStream stream_id=new RewriteRuleSubtreeStream(adaptor,"rule id");
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:174:2: ( '@' id ACTION -> ^( '@' id ACTION ) )
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:174:4: '@' id ACTION
            {
            ...
            // 174:18: -> ^( '@' id ACTION )
            {
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:174:21: ^( '@' id ACTION )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
                root_1 = (CommonTree)adaptor.becomeRoot(stream_72.nextNode(), root_1);
    ...
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:177:1: throwsSpec : 'throws' id ( ',' id )* -> ^( 'throws' ( id )+ ) ;
    public final ANTLRv3Parser.throwsSpec_return throwsSpec() throws RecognitionException {
        ...
        RewriteRuleSubtreeStream stream_id=new RewriteRuleSubtreeStream(adaptor,"rule id");
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:178:2: ( 'throws' id ( ',' id )* -> ^( 'throws' ( id )+ ) )
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:178:4: 'throws' id ( ',' id )*
            {
            ...
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:178:16: ( ',' id )*
            loop26:
            do {
                int alt26=2;
                ...
                switch (alt26) {
            	case 1 :
            	    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:178:18: ',' id
            	    {
            ...
            // 178:28: -> ^( 'throws' ( id )+ )
            {
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:178:31: ^( 'throws' ( id )+ )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
    ...
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:181:1: ruleScopeSpec : ( 'scope' ACTION -> ^( 'scope' ACTION ) | 'scope' id ( ',' id )* ';' -> ^( 'scope' ( id )+ ) | 'scope' ACTION 'scope' id ( ',' id )* ';' -> ^( 'scope' ACTION ( id )+ ) );
    public final ANTLRv3Parser.ruleScopeSpec_return ruleScopeSpec() throws RecognitionException {
        ...
        RewriteRuleSubtreeStream stream_id=new RewriteRuleSubtreeStream(adaptor,"rule id");
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:182:2: ( 'scope' ACTION -> ^( 'scope' ACTION ) | 'scope' id ( ',' id )* ';' -> ^( 'scope' ( id )+ ) | 'scope' ACTION 'scope' id ( ',' id )* ';' -> ^( 'scope' ACTION ( id )+ ) )
            int alt29=3;
            ...
            switch (alt29) {
                case 1 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:182:4: 'scope' ACTION
                    {
                    ...
                    // 182:19: -> ^( 'scope' ACTION )
                    {
                        // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:182:22: ^( 'scope' ACTION )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                        root_1 = (CommonTree)adaptor.becomeRoot(stream_SCOPE.nextNode(), root_1);
                    ...
                    break;
                case 2 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:183:4: 'scope' id ( ',' id )* ';'
                    {
                    ...
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:183:15: ( ',' id )*
                    loop27:
                    do {
                        int alt27=2;
                        ...
                        switch (alt27) {
                    	case 1 :
                    	    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:183:16: ',' id
                    	    {
                    ...
                    // 183:29: -> ^( 'scope' ( id )+ )
                    {
                        // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:183:32: ^( 'scope' ( id )+ )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                        root_1 = (CommonTree)adaptor.becomeRoot(stream_SCOPE.nextNode(), root_1);
                    ...
                    break;
                case 3 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:184:4: 'scope' ACTION 'scope' id ( ',' id )* ';'
                    {
                    ...
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:185:14: ( ',' id )*
                    loop28:
                    do {
                        int alt28=2;
                        ...
                        switch (alt28) {
                    	case 1 :
                    	    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:185:15: ',' id
                    	    {
                    ...
                    {
                        // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:186:6: ^( 'scope' ACTION ( id )+ )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                        root_1 = (CommonTree)adaptor.becomeRoot(stream_SCOPE.nextNode(), root_1);
    ...
    // $ANTLR start "block"
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:189:1: block : lp= '(' ( (opts= optionsSpec )? ':' )? a1= alternative rewrite ( '|' a2= alternative rewrite )* rp= ')' -> ^( BLOCK[$lp,\"BLOCK\"] ( optionsSpec )? ( alternative ( rewrite )? )+ EOB[$rp,\"EOB\"] ) ;
    public final ANTLRv3Parser.block_return block() throws RecognitionException {
        ...
        RewriteRuleSubtreeStream stream_optionsSpec=new RewriteRuleSubtreeStream(adaptor,"rule optionsSpec");
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:190:5: (lp= '(' ( (opts= optionsSpec )? ':' )? a1= alternative rewrite ( '|' a2= alternative rewrite )* rp= ')' -> ^( BLOCK[$lp,\"BLOCK\"] ( optionsSpec )? ( alternative ( rewrite )? )+ EOB[$rp,\"EOB\"] ) )
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:190:9: lp= '(' ( (opts= optionsSpec )? ':' )? a1= alternative rewrite ( '|' a2= alternative rewrite )* rp= ')'
            {
            lp=(Token)match(input,82,FOLLOW_82_in_block1176); if (state.failed) return retval; 
            if ( state.backtracking==0 ) stream_82.add(lp);

            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:191:3: ( (opts= optionsSpec )? ':' )?
            int alt31=2;
            ...
            switch (alt31) {
                case 1 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:191:5: (opts= optionsSpec )? ':'
                    {
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:191:5: (opts= optionsSpec )?
                    int alt30=2;
                    ...
                    switch (alt30) {
                        case 1 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:191:6: opts= optionsSpec
                            {
            ...
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:192:26: ( '|' a2= alternative rewrite )*
            loop32:
            do {
                int alt32=2;
                ...
                switch (alt32) {
            	case 1 :
            	    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:192:28: '|' a2= alternative rewrite
            	    {
            ...
            {
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:194:12: ^( BLOCK[$lp,\"BLOCK\"] ( optionsSpec )? ( alternative ( rewrite )? )+ EOB[$rp,\"EOB\"] )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
                root_1 = (CommonTree)adaptor.becomeRoot((CommonTree)adaptor.create(BLOCK, lp, "BLOCK"), root_1);

                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:194:34: ( optionsSpec )?
                if ( stream_optionsSpec.hasNext() ) {
                    adaptor.addChild(root_1, stream_optionsSpec.nextTree());
                ...
                while ( stream_alternative.hasNext() ) {
                    ...
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:194:60: ( rewrite )?
    ...
    // $ANTLR start "altList"
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:197:1: altList : a1= alternative rewrite ( '|' a2= alternative rewrite )* -> ^( ( alternative ( rewrite )? )+ EOB[\"EOB\"] ) ;
    public final ANTLRv3Parser.altList_return altList() throws RecognitionException {
        ...
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:204:5: (a1= alternative rewrite ( '|' a2= alternative rewrite )* -> ^( ( alternative ( rewrite )? )+ EOB[\"EOB\"] ) )
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:204:9: a1= alternative rewrite ( '|' a2= alternative rewrite )*
            {
            ...
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:204:32: ( '|' a2= alternative rewrite )*
            loop33:
            do {
                int alt33=2;
                ...
                switch (alt33) {
            	case 1 :
            	    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:204:34: '|' a2= alternative rewrite
            	    {
            ...
            {
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:205:6: ^( ( alternative ( rewrite )? )+ EOB[\"EOB\"] )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
                ...
                while ( stream_alternative.hasNext() ) {
                    adaptor.addChild(root_1, stream_alternative.nextTree());
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:205:32: ( rewrite )?
                    if ( stream_rewrite.hasNext() ) {
                        adaptor.addChild(root_1, stream_rewrite.nextTree());
    ...
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:208:1: alternative : ( ( element )+ -> ^( ALT[firstToken,\"ALT\"] ( element )+ EOA[\"EOA\"] ) | -> ^( ALT[prevToken,\"ALT\"] EPSILON[prevToken,\"EPSILON\"] EOA[\"EOA\"] ) );
    public final ANTLRv3Parser.alternative_return alternative() throws RecognitionException {
        ...
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:213:5: ( ( element )+ -> ^( ALT[firstToken,\"ALT\"] ( element )+ EOA[\"EOA\"] ) | -> ^( ALT[prevToken,\"ALT\"] EPSILON[prevToken,\"EPSILON\"] EOA[\"EOA\"] ) )
            int alt35=2;
            ...
            switch (alt35) {
                case 1 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:213:9: ( element )+
                    {
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:213:9: ( element )+
                    int cnt34=0;
                    loop34:
                    ...
                    {
                        // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:213:21: ^( ALT[firstToken,\"ALT\"] ( element )+ EOA[\"EOA\"] )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:214:9: 
                    {
                    ...
                    {
                        // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:214:12: ^( ALT[prevToken,\"ALT\"] EPSILON[prevToken,\"EPSILON\"] EOA[\"EOA\"] )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
    ...
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:217:1: exceptionGroup : ( ( exceptionHandler )+ ( finallyClause )? | finallyClause );
    public final ANTLRv3Parser.exceptionGroup_return exceptionGroup() throws RecognitionException {
        ...
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:218:2: ( ( exceptionHandler )+ ( finallyClause )? | finallyClause )
            int alt38=2;
            ...
            switch (alt38) {
                case 1 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:218:4: ( exceptionHandler )+ ( finallyClause )?
                    {
                    root_0 = (CommonTree)adaptor.nil();

                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:218:4: ( exceptionHandler )+
                    int cnt36=0;
                    loop36:
                    do {
                        int alt36=2;
                        ...
                        switch (alt36) {
                    	case 1 :
                    	    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:218:6: exceptionHandler
                    	    {
                    ...
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:218:26: ( finallyClause )?
                    int alt37=2;
                    ...
                    switch (alt37) {
                        case 1 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:218:28: finallyClause
                            {
                    ...
                    break;
                case 2 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:219:4: finallyClause
                    {
                    root_0 = (CommonTree)adaptor.nil();
    ...
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:222:1: exceptionHandler : 'catch' ARG_ACTION ACTION -> ^( 'catch' ARG_ACTION ACTION ) ;
    public final ANTLRv3Parser.exceptionHandler_return exceptionHandler() throws RecognitionException {
        ...
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:223:5: ( 'catch' ARG_ACTION ACTION -> ^( 'catch' ARG_ACTION ACTION ) )
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:223:10: 'catch' ARG_ACTION ACTION
            {
            ...
            {
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:223:39: ^( 'catch' ARG_ACTION ACTION )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
    ...
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:226:1: finallyClause : 'finally' ACTION -> ^( 'finally' ACTION ) ;
    public final ANTLRv3Parser.finallyClause_return finallyClause() throws RecognitionException {
        ...
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:227:5: ( 'finally' ACTION -> ^( 'finally' ACTION ) )
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:227:10: 'finally' ACTION
            {
            ...
            {
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:227:30: ^( 'finally' ACTION )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
    ...
    // $ANTLR start "element"
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:230:1: element : elementNoOptionSpec ;
    public final ANTLRv3Parser.element_return element() throws RecognitionException {
        ...
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:231:2: ( elementNoOptionSpec )
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:231:4: elementNoOptionSpec
            {
            root_0 = (CommonTree)adaptor.nil();
    ...
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:234:1: elementNoOptionSpec : ( id (labelOp= '=' | labelOp= '+=' ) atom ( ebnfSuffix -> ^( ebnfSuffix ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] ^( $labelOp id atom ) EOA[\"EOA\"] ) EOB[\"EOB\"] ) ) | -> ^( $labelOp id atom ) ) | id (labelOp= '=' | labelOp= '+=' ) block ( ebnfSuffix -> ^( ebnfSuffix ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] ^( $labelOp id block ) EOA[\"EOA\"] ) EOB[\"EOB\"] ) ) | -> ^( $labelOp id block ) ) | atom ( ebnfSuffix -> ^( ebnfSuffix ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] atom EOA[\"EOA\"] ) EOB[\"EOB\"] ) ) | -> atom ) | ebnf | ACTION | SEMPRED ( '=>' -> GATED_SEMPRED | -> SEMPRED ) | treeSpec ( ebnfSuffix -> ^( ebnfSuffix ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] treeSpec EOA[\"EOA\"] ) EOB[\"EOB\"] ) ) | -> treeSpec ) );
        ...
        try {
            ...
            switch (alt46) {
                case 1 :
                    ...
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:235:7: (labelOp= '=' | labelOp= '+=' )
                    int alt39=2;
                    ...
                    switch (alt39) {
                        case 1 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:235:8: labelOp= '='
                            {
                            ...
                            break;
                        case 2 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:235:20: labelOp= '+='
                            {
                    ...
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:236:3: ( ebnfSuffix -> ^( ebnfSuffix ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] ^( $labelOp id atom ) EOA[\"EOA\"] ) EOB[\"EOB\"] ) ) | -> ^( $labelOp id atom ) )
                    int alt40=2;
                    ...
                    switch (alt40) {
                        case 1 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:236:5: ebnfSuffix
                            {
                            ...
                            {
                                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:236:19: ^( ebnfSuffix ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] ^( $labelOp id atom ) EOA[\"EOA\"] ) EOB[\"EOB\"] ) )
                                {
                                CommonTree root_1 = (CommonTree)adaptor.nil();
                                root_1 = (CommonTree)adaptor.becomeRoot(stream_ebnfSuffix.nextNode(), root_1);

                                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:236:33: ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] ^( $labelOp id atom ) EOA[\"EOA\"] ) EOB[\"EOB\"] )
                                {
                                CommonTree root_2 = (CommonTree)adaptor.nil();
                                root_2 = (CommonTree)adaptor.becomeRoot((CommonTree)adaptor.create(BLOCK, "BLOCK"), root_2);

                                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:236:50: ^( ALT[\"ALT\"] ^( $labelOp id atom ) EOA[\"EOA\"] )
                                {
                                CommonTree root_3 = (CommonTree)adaptor.nil();
                                root_3 = (CommonTree)adaptor.becomeRoot((CommonTree)adaptor.create(ALT, "ALT"), root_3);

                                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:236:63: ^( $labelOp id atom )
                                {
                            ...
                            break;
                        case 2 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:237:8: 
                            {
                            ...
                            {
                                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:237:11: ^( $labelOp id atom )
                                {
                                CommonTree root_1 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:239:4: id (labelOp= '=' | labelOp= '+=' ) block ( ebnfSuffix -> ^( ebnfSuffix ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] ^( $labelOp id block ) EOA[\"EOA\"] ) EOB[\"EOB\"] ) ) | -> ^( $labelOp id block ) )
                    {
                    ...
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:239:7: (labelOp= '=' | labelOp= '+=' )
                    int alt41=2;
                    ...
                    switch (alt41) {
                        case 1 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:239:8: labelOp= '='
                            {
                            ...
                            break;
                        case 2 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:239:20: labelOp= '+='
                            {
                    ...
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:240:3: ( ebnfSuffix -> ^( ebnfSuffix ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] ^( $labelOp id block ) EOA[\"EOA\"] ) EOB[\"EOB\"] ) ) | -> ^( $labelOp id block ) )
                    int alt42=2;
                    ...
                    switch (alt42) {
                        case 1 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:240:5: ebnfSuffix
                            {
                            ...
                            // AST REWRITE
                            // elements: ebnfSuffix, block, labelOp, id
                            // token labels: labelOp
                            // rule labels: retval
                            // token list labels: 
                            // rule list labels: 
                            ...
                            {
                                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:240:19: ^( ebnfSuffix ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] ^( $labelOp id block ) EOA[\"EOA\"] ) EOB[\"EOB\"] ) )
                                {
                                CommonTree root_1 = (CommonTree)adaptor.nil();
                                root_1 = (CommonTree)adaptor.becomeRoot(stream_ebnfSuffix.nextNode(), root_1);

                                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:240:33: ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] ^( $labelOp id block ) EOA[\"EOA\"] ) EOB[\"EOB\"] )
                                {
                                CommonTree root_2 = (CommonTree)adaptor.nil();
                                root_2 = (CommonTree)adaptor.becomeRoot((CommonTree)adaptor.create(BLOCK, "BLOCK"), root_2);

                                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:240:50: ^( ALT[\"ALT\"] ^( $labelOp id block ) EOA[\"EOA\"] )
                                {
                                CommonTree root_3 = (CommonTree)adaptor.nil();
                                root_3 = (CommonTree)adaptor.becomeRoot((CommonTree)adaptor.create(ALT, "ALT"), root_3);

                                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:240:63: ^( $labelOp id block )
                                {
                                CommonTree root_4 = (CommonTree)adaptor.nil();
                                root_4 = (CommonTree)adaptor.becomeRoot(stream_labelOp.nextNode(), root_4);
                            ...
                            break;
                        case 2 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:241:8: 
                            {
                            ...
                            {
                                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:241:11: ^( $labelOp id block )
                                {
                                CommonTree root_1 = (CommonTree)adaptor.nil();
                                root_1 = (CommonTree)adaptor.becomeRoot(stream_labelOp.nextNode(), root_1);
                    ...
                    break;
                case 3 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:243:4: atom ( ebnfSuffix -> ^( ebnfSuffix ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] atom EOA[\"EOA\"] ) EOB[\"EOB\"] ) ) | -> atom )
                    {
                    ...
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:244:3: ( ebnfSuffix -> ^( ebnfSuffix ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] atom EOA[\"EOA\"] ) EOB[\"EOB\"] ) ) | -> atom )
                    int alt43=2;
                    ...
                    switch (alt43) {
                        case 1 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:244:5: ebnfSuffix
                            {
                            ...
                            {
                                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:244:19: ^( ebnfSuffix ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] atom EOA[\"EOA\"] ) EOB[\"EOB\"] ) )
                                {
                                CommonTree root_1 = (CommonTree)adaptor.nil();
                                root_1 = (CommonTree)adaptor.becomeRoot(stream_ebnfSuffix.nextNode(), root_1);

                                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:244:33: ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] atom EOA[\"EOA\"] ) EOB[\"EOB\"] )
                                {
                                CommonTree root_2 = (CommonTree)adaptor.nil();
                                root_2 = (CommonTree)adaptor.becomeRoot((CommonTree)adaptor.create(BLOCK, "BLOCK"), root_2);

                                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:244:50: ^( ALT[\"ALT\"] atom EOA[\"EOA\"] )
                                {
                                CommonTree root_3 = (CommonTree)adaptor.nil();
                                root_3 = (CommonTree)adaptor.becomeRoot((CommonTree)adaptor.create(ALT, "ALT"), root_3);
                            ...
                            break;
                        case 2 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:245:8: 
                            {
                    ...
                    break;
                case 4 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:247:4: ebnf
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 5 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:248:6: ACTION
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 6 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:249:6: SEMPRED ( '=>' -> GATED_SEMPRED | -> SEMPRED )
                    {
                    ...
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:249:14: ( '=>' -> GATED_SEMPRED | -> SEMPRED )
                    int alt44=2;
                    ...
                    switch (alt44) {
                        case 1 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:249:16: '=>'
                            {
                            ...
                            break;
                        case 2 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:249:40: 
                            {
                    ...
                    break;
                case 7 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:250:6: treeSpec ( ebnfSuffix -> ^( ebnfSuffix ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] treeSpec EOA[\"EOA\"] ) EOB[\"EOB\"] ) ) | -> treeSpec )
                    {
                    ...
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:251:3: ( ebnfSuffix -> ^( ebnfSuffix ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] treeSpec EOA[\"EOA\"] ) EOB[\"EOB\"] ) ) | -> treeSpec )
                    int alt45=2;
                    ...
                    switch (alt45) {
                        case 1 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:251:5: ebnfSuffix
                            {
                            ...
                            {
                                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:251:19: ^( ebnfSuffix ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] treeSpec EOA[\"EOA\"] ) EOB[\"EOB\"] ) )
                                {
                                CommonTree root_1 = (CommonTree)adaptor.nil();
                                root_1 = (CommonTree)adaptor.becomeRoot(stream_ebnfSuffix.nextNode(), root_1);

                                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:251:33: ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] treeSpec EOA[\"EOA\"] ) EOB[\"EOB\"] )
                                {
                                CommonTree root_2 = (CommonTree)adaptor.nil();
                                root_2 = (CommonTree)adaptor.becomeRoot((CommonTree)adaptor.create(BLOCK, "BLOCK"), root_2);

                                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:251:50: ^( ALT[\"ALT\"] treeSpec EOA[\"EOA\"] )
                                {
                                CommonTree root_3 = (CommonTree)adaptor.nil();
                                root_3 = (CommonTree)adaptor.becomeRoot((CommonTree)adaptor.create(ALT, "ALT"), root_3);
                            ...
                            break;
                        case 2 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:252:8: 
                            {
    ...
    // $ANTLR start "atom"
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:256:1: atom : ( range ( (op= '^' | op= '!' ) -> ^( $op range ) | -> range ) | terminal | notSet ( (op= '^' | op= '!' ) -> ^( $op notSet ) | -> notSet ) | RULE_REF (arg= ARG_ACTION )? ( (op= '^' | op= '!' ) )? -> {$arg!=null&&op!=null}? ^( $op RULE_REF $arg) -> {$arg!=null}? ^( RULE_REF $arg) -> {$op!=null}? ^( $op RULE_REF ) -> RULE_REF );
    public final ANTLRv3Parser.atom_return atom() throws RecognitionException {
        ...
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:256:5: ( range ( (op= '^' | op= '!' ) -> ^( $op range ) | -> range ) | terminal | notSet ( (op= '^' | op= '!' ) -> ^( $op notSet ) | -> notSet ) | RULE_REF (arg= ARG_ACTION )? ( (op= '^' | op= '!' ) )? -> {$arg!=null&&op!=null}? ^( $op RULE_REF $arg) -> {$arg!=null}? ^( RULE_REF $arg) -> {$op!=null}? ^( $op RULE_REF ) -> RULE_REF )
            int alt54=4;
            switch ( input.LA(1) ) {
            case CHAR_LITERAL:
                {
            ...
            switch (alt54) {
                case 1 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:256:9: range ( (op= '^' | op= '!' ) -> ^( $op range ) | -> range )
                    {
                    ...
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:256:15: ( (op= '^' | op= '!' ) -> ^( $op range ) | -> range )
                    int alt48=2;
                    ...
                    switch (alt48) {
                        case 1 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:256:17: (op= '^' | op= '!' )
                            {
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:256:17: (op= '^' | op= '!' )
                            int alt47=2;
                            ...
                            switch (alt47) {
                                case 1 :
                                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:256:18: op= '^'
                                    {
                                    ...
                                    break;
                                case 2 :
                                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:256:25: op= '!'
                                    {
                            ...
                            // 256:33: -> ^( $op range )
                            {
                                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:256:36: ^( $op range )
                                {
                                CommonTree root_1 = (CommonTree)adaptor.nil();
                            ...
                            break;
                        case 2 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:256:51: 
                            {
                    ...
                    break;
                case 2 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:257:9: terminal
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 3 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:258:7: notSet ( (op= '^' | op= '!' ) -> ^( $op notSet ) | -> notSet )
                    {
                    ...
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:258:14: ( (op= '^' | op= '!' ) -> ^( $op notSet ) | -> notSet )
                    int alt50=2;
                    ...
                    switch (alt50) {
                        case 1 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:258:16: (op= '^' | op= '!' )
                            {
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:258:16: (op= '^' | op= '!' )
                            int alt49=2;
                            ...
                            switch (alt49) {
                                case 1 :
                                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:258:17: op= '^'
                                    {
                                    ...
                                    break;
                                case 2 :
                                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:258:24: op= '!'
                                    {
                            ...
                            // 258:32: -> ^( $op notSet )
                            {
                                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:258:35: ^( $op notSet )
                                {
                                CommonTree root_1 = (CommonTree)adaptor.nil();
                                root_1 = (CommonTree)adaptor.becomeRoot(stream_op.nextNode(), root_1);
                            ...
                            break;
                        case 2 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:258:51: 
                            {
                    ...
                    break;
                case 4 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:259:9: RULE_REF (arg= ARG_ACTION )? ( (op= '^' | op= '!' ) )?
                    {
                    ...
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:259:18: (arg= ARG_ACTION )?
                    int alt51=2;
                    ...
                    switch (alt51) {
                        case 1 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:259:20: arg= ARG_ACTION
                            {
                    ...
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:259:38: ( (op= '^' | op= '!' ) )?
                    int alt53=2;
                    ...
                    switch (alt53) {
                        case 1 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:259:40: (op= '^' | op= '!' )
                            {
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:259:40: (op= '^' | op= '!' )
                            int alt52=2;
                            ...
                            switch (alt52) {
                                case 1 :
                                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:259:41: op= '^'
                                    {
                                    ...
                                    break;
                                case 2 :
                                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:259:48: op= '!'
                                    {
                    ...
                    // AST REWRITE
                    // elements: arg, RULE_REF, RULE_REF, RULE_REF, arg, op, op, RULE_REF
                    // token labels: arg, op
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                    ...
                    if (arg!=null&&op!=null) {
                        // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:260:33: ^( $op RULE_REF $arg)
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                        root_1 = (CommonTree)adaptor.becomeRoot(stream_op.nextNode(), root_1);
                    ...
                    if (arg!=null) {
                        // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:261:25: ^( RULE_REF $arg)
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                    ...
                    if (op!=null) {
                        // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:262:25: ^( $op RULE_REF )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                        root_1 = (CommonTree)adaptor.becomeRoot(stream_op.nextNode(), root_1);
    ...
    // $ANTLR start "notSet"
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:266:1: notSet : '~' ( notTerminal -> ^( '~' notTerminal ) | block -> ^( '~' block ) ) ;
    public final ANTLRv3Parser.notSet_return notSet() throws RecognitionException {
        ...
        RewriteRuleSubtreeStream stream_block=new RewriteRuleSubtreeStream(adaptor,"rule block");
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:267:2: ( '~' ( notTerminal -> ^( '~' notTerminal ) | block -> ^( '~' block ) ) )
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:267:4: '~' ( notTerminal -> ^( '~' notTerminal ) | block -> ^( '~' block ) )
            {
            ...
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:268:3: ( notTerminal -> ^( '~' notTerminal ) | block -> ^( '~' block ) )
            int alt55=2;
            ...
            switch (alt55) {
                case 1 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:268:5: notTerminal
                    {
                    ...
                    // 268:17: -> ^( '~' notTerminal )
                    {
                        // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:268:20: ^( '~' notTerminal )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:269:5: block
                    {
                    ...
                    // 269:12: -> ^( '~' block )
                    {
                        // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:269:15: ^( '~' block )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                        root_1 = (CommonTree)adaptor.becomeRoot(stream_89.nextNode(), root_1);
    ...
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:273:1: treeSpec : '^(' element ( element )+ ')' -> ^( TREE_BEGIN ( element )+ ) ;
    public final ANTLRv3Parser.treeSpec_return treeSpec() throws RecognitionException {
        ...
        RewriteRuleSubtreeStream stream_element=new RewriteRuleSubtreeStream(adaptor,"rule element");
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:274:2: ( '^(' element ( element )+ ')' -> ^( TREE_BEGIN ( element )+ ) )
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:274:4: '^(' element ( element )+ ')'
            {
            ...
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:274:17: ( element )+
            int cnt56=0;
            loop56:
            do {
                int alt56=2;
                ...
                switch (alt56) {
            	case 1 :
            	    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:274:19: element
            	    {
            ...
            {
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:274:37: ^( TREE_BEGIN ( element )+ )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
    ...
    // $ANTLR start "ebnf"
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:277:1: ebnf : block (op= '?' -> ^( OPTIONAL[op] block ) | op= '*' -> ^( CLOSURE[op] block ) | op= '+' -> ^( POSITIVE_CLOSURE[op] block ) | '=>' -> {gtype==COMBINED_GRAMMAR &&\n\t\t\t\t\t Character.isUpperCase($rule::name.charAt(0))}? ^( SYNPRED[\"=>\"] block ) -> SYN_SEMPRED | -> block ) ;
    public final ANTLRv3Parser.ebnf_return ebnf() throws RecognitionException {
        ...
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:286:2: ( block (op= '?' -> ^( OPTIONAL[op] block ) | op= '*' -> ^( CLOSURE[op] block ) | op= '+' -> ^( POSITIVE_CLOSURE[op] block ) | '=>' -> {gtype==COMBINED_GRAMMAR &&\n\t\t\t\t\t Character.isUpperCase($rule::name.charAt(0))}? ^( SYNPRED[\"=>\"] block ) -> SYN_SEMPRED | -> block ) )
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:286:4: block (op= '?' -> ^( OPTIONAL[op] block ) | op= '*' -> ^( CLOSURE[op] block ) | op= '+' -> ^( POSITIVE_CLOSURE[op] block ) | '=>' -> {gtype==COMBINED_GRAMMAR &&\n\t\t\t\t\t Character.isUpperCase($rule::name.charAt(0))}? ^( SYNPRED[\"=>\"] block ) -> SYN_SEMPRED | -> block )
            {
            ...
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:287:3: (op= '?' -> ^( OPTIONAL[op] block ) | op= '*' -> ^( CLOSURE[op] block ) | op= '+' -> ^( POSITIVE_CLOSURE[op] block ) | '=>' -> {gtype==COMBINED_GRAMMAR &&\n\t\t\t\t\t Character.isUpperCase($rule::name.charAt(0))}? ^( SYNPRED[\"=>\"] block ) -> SYN_SEMPRED | -> block )
            int alt57=5;
            switch ( input.LA(1) ) {
            case 90:
                {
            ...
            switch (alt57) {
                case 1 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:287:5: op= '?'
                    {
                    ...
                    {
                        // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:287:15: ^( OPTIONAL[op] block )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:288:5: op= '*'
                    {
                    ...
                    {
                        // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:288:15: ^( CLOSURE[op] block )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 3 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:289:5: op= '+'
                    {
                    ...
                    {
                        // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:289:15: ^( POSITIVE_CLOSURE[op] block )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 4 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:290:7: '=>'
                    {
                    ...
                    if (gtype==COMBINED_GRAMMAR &&
                        ...
                        // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:294:9: ^( SYNPRED[\"=>\"] block )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 5 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:297:13: 
                    {
    ...
    // $ANTLR start "range"
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:301:1: range : c1= CHAR_LITERAL RANGE c2= CHAR_LITERAL -> ^( CHAR_RANGE[$c1,\"..\"] $c1 $c2) ;
    public final ANTLRv3Parser.range_return range() throws RecognitionException {
        ...
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:302:2: (c1= CHAR_LITERAL RANGE c2= CHAR_LITERAL -> ^( CHAR_RANGE[$c1,\"..\"] $c1 $c2) )
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:302:4: c1= CHAR_LITERAL RANGE c2= CHAR_LITERAL
            {
            ...
            {
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:302:45: ^( CHAR_RANGE[$c1,\"..\"] $c1 $c2)
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
    ...
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:305:1: terminal : ( CHAR_LITERAL -> CHAR_LITERAL | TOKEN_REF ( ARG_ACTION -> ^( TOKEN_REF ARG_ACTION ) | -> TOKEN_REF ) | STRING_LITERAL -> STRING_LITERAL | '.' -> '.' ) ( '^' -> ^( '^' $terminal) | '!' -> ^( '!' $terminal) )? ;
    public final ANTLRv3Parser.terminal_return terminal() throws RecognitionException {
        ...
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:306:5: ( ( CHAR_LITERAL -> CHAR_LITERAL | TOKEN_REF ( ARG_ACTION -> ^( TOKEN_REF ARG_ACTION ) | -> TOKEN_REF ) | STRING_LITERAL -> STRING_LITERAL | '.' -> '.' ) ( '^' -> ^( '^' $terminal) | '!' -> ^( '!' $terminal) )? )
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:306:9: ( CHAR_LITERAL -> CHAR_LITERAL | TOKEN_REF ( ARG_ACTION -> ^( TOKEN_REF ARG_ACTION ) | -> TOKEN_REF ) | STRING_LITERAL -> STRING_LITERAL | '.' -> '.' ) ( '^' -> ^( '^' $terminal) | '!' -> ^( '!' $terminal) )?
            {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:306:9: ( CHAR_LITERAL -> CHAR_LITERAL | TOKEN_REF ( ARG_ACTION -> ^( TOKEN_REF ARG_ACTION ) | -> TOKEN_REF ) | STRING_LITERAL -> STRING_LITERAL | '.' -> '.' )
            int alt59=4;
            switch ( input.LA(1) ) {
            case CHAR_LITERAL:
                {
            ...
            switch (alt59) {
                case 1 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:306:11: CHAR_LITERAL
                    {
                    ...
                    break;
                case 2 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:308:7: TOKEN_REF ( ARG_ACTION -> ^( TOKEN_REF ARG_ACTION ) | -> TOKEN_REF )
                    {
                    ...
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:309:4: ( ARG_ACTION -> ^( TOKEN_REF ARG_ACTION ) | -> TOKEN_REF )
                    int alt58=2;
                    ...
                    switch (alt58) {
                        case 1 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:309:6: ARG_ACTION
                            {
                            ...
                            {
                                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:309:23: ^( TOKEN_REF ARG_ACTION )
                                {
                                CommonTree root_1 = (CommonTree)adaptor.nil();
                            ...
                            break;
                        case 2 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:310:12: 
                            {
                    ...
                    break;
                case 3 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:312:7: STRING_LITERAL
                    {
                    ...
                    break;
                case 4 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:313:7: '.'
                    {
            ...
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:315:3: ( '^' -> ^( '^' $terminal) | '!' -> ^( '!' $terminal) )?
            int alt60=3;
            ...
            switch (alt60) {
                case 1 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:315:5: '^'
                    {
                    ...
                    // 315:15: -> ^( '^' $terminal)
                    {
                        // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:315:18: ^( '^' $terminal)
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:316:5: '!'
                    {
                    ...
                    // 316:15: -> ^( '!' $terminal)
                    {
                        // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:316:18: ^( '!' $terminal)
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
    ...
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:320:1: notTerminal : ( CHAR_LITERAL | TOKEN_REF | STRING_LITERAL );
    public final ANTLRv3Parser.notTerminal_return notTerminal() throws RecognitionException {
        ...
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:321:2: ( CHAR_LITERAL | TOKEN_REF | STRING_LITERAL )
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:
            {
            root_0 = (CommonTree)adaptor.nil();
    ...
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:326:1: ebnfSuffix : ( '?' -> OPTIONAL[op] | '*' -> CLOSURE[op] | '+' -> POSITIVE_CLOSURE[op] );
    public final ANTLRv3Parser.ebnfSuffix_return ebnfSuffix() throws RecognitionException {
        ...
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:330:2: ( '?' -> OPTIONAL[op] | '*' -> CLOSURE[op] | '+' -> POSITIVE_CLOSURE[op] )
            int alt61=3;
            switch ( input.LA(1) ) {
            case 90:
                {
            ...
            switch (alt61) {
                case 1 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:330:4: '?'
                    {
                    ...
                    break;
                case 2 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:331:6: '*'
                    {
                    ...
                    break;
                case 3 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:332:7: '+'
                    {
    ...
    // $ANTLR start "rewrite"
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:339:1: rewrite : ( (rew+= '->' preds+= SEMPRED predicated+= rewrite_alternative )* rew2= '->' last= rewrite_alternative -> ( ^( $rew $preds $predicated) )* ^( $rew2 $last) | );
    public final ANTLRv3Parser.rewrite_return rewrite() throws RecognitionException {
        ...
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:343:2: ( (rew+= '->' preds+= SEMPRED predicated+= rewrite_alternative )* rew2= '->' last= rewrite_alternative -> ( ^( $rew $preds $predicated) )* ^( $rew2 $last) | )
            int alt63=2;
            ...
            switch (alt63) {
                case 1 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:343:4: (rew+= '->' preds+= SEMPRED predicated+= rewrite_alternative )* rew2= '->' last= rewrite_alternative
                    {
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:343:4: (rew+= '->' preds+= SEMPRED predicated+= rewrite_alternative )*
                    loop62:
                    do {
                        int alt62=2;
                        ...
                        switch (alt62) {
                    	case 1 :
                    	    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:343:5: rew+= '->' preds+= SEMPRED predicated+= rewrite_alternative
                    	    {
                    ...
                    // AST REWRITE
                    // elements: preds, last, rew2, predicated, rew
                    // token labels: rew2
                    ...
                    {
                        // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:345:12: ( ^( $rew $preds $predicated) )*
                        ...
                        stream_rew.reset();
                        // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:345:40: ^( $rew2 $last)
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:347:2: 
                    {
                    root_0 = (CommonTree)adaptor.nil();
    ...
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:349:1: rewrite_alternative options {backtrack=true; } : ( rewrite_template | rewrite_tree_alternative | -> ^( ALT[\"ALT\"] EPSILON[\"EPSILON\"] EOA[\"EOA\"] ) );
    public final ANTLRv3Parser.rewrite_alternative_return rewrite_alternative() throws RecognitionException {
        ...
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:351:2: ( rewrite_template | rewrite_tree_alternative | -> ^( ALT[\"ALT\"] EPSILON[\"EPSILON\"] EOA[\"EOA\"] ) )
            int alt64=3;
            alt64 = dfa64.predict(input);
            switch (alt64) {
                case 1 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:351:4: rewrite_template
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:352:4: rewrite_tree_alternative
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 3 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:353:29: 
                    {
                    ...
                    {
                        // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:353:32: ^( ALT[\"ALT\"] EPSILON[\"EPSILON\"] EOA[\"EOA\"] )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
    ...
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:356:1: rewrite_tree_block : lp= '(' rewrite_tree_alternative ')' -> ^( BLOCK[$lp,\"BLOCK\"] rewrite_tree_alternative EOB[$lp,\"EOB\"] ) ;
    public final ANTLRv3Parser.rewrite_tree_block_return rewrite_tree_block() throws RecognitionException {
        ...
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:357:5: (lp= '(' rewrite_tree_alternative ')' -> ^( BLOCK[$lp,\"BLOCK\"] rewrite_tree_alternative EOB[$lp,\"EOB\"] ) )
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:357:9: lp= '(' rewrite_tree_alternative ')'
            {
            ...
            {
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:358:9: ^( BLOCK[$lp,\"BLOCK\"] rewrite_tree_alternative EOB[$lp,\"EOB\"] )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
                root_1 = (CommonTree)adaptor.becomeRoot((CommonTree)adaptor.create(BLOCK, lp, "BLOCK"), root_1);
    ...
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:361:1: rewrite_tree_alternative : ( rewrite_tree_element )+ -> ^( ALT[\"ALT\"] ( rewrite_tree_element )+ EOA[\"EOA\"] ) ;
    public final ANTLRv3Parser.rewrite_tree_alternative_return rewrite_tree_alternative() throws RecognitionException {
        ...
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:362:5: ( ( rewrite_tree_element )+ -> ^( ALT[\"ALT\"] ( rewrite_tree_element )+ EOA[\"EOA\"] ) )
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:362:7: ( rewrite_tree_element )+
            {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:362:7: ( rewrite_tree_element )+
            int cnt65=0;
            loop65:
            ...
            {
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:362:32: ^( ALT[\"ALT\"] ( rewrite_tree_element )+ EOA[\"EOA\"] )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
                root_1 = (CommonTree)adaptor.becomeRoot((CommonTree)adaptor.create(ALT, "ALT"), root_1);
    ...
    public final ANTLRv3Parser.rewrite_tree_element_return rewrite_tree_element() throws RecognitionException {
        ...
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:366:2: ( rewrite_tree_atom | rewrite_tree_atom ebnfSuffix -> ^( ebnfSuffix ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] rewrite_tree_atom EOA[\"EOA\"] ) EOB[\"EOB\"] ) ) | rewrite_tree ( ebnfSuffix -> ^( ebnfSuffix ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] rewrite_tree EOA[\"EOA\"] ) EOB[\"EOB\"] ) ) | -> rewrite_tree ) | rewrite_tree_ebnf )
            int alt67=4;
            alt67 = dfa67.predict(input);
            switch (alt67) {
                case 1 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:366:4: rewrite_tree_atom
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:367:4: rewrite_tree_atom ebnfSuffix
                    {
                    ...
                    {
                        // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:368:6: ^( ebnfSuffix ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] rewrite_tree_atom EOA[\"EOA\"] ) EOB[\"EOB\"] ) )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                        root_1 = (CommonTree)adaptor.becomeRoot(stream_ebnfSuffix.nextNode(), root_1);

                        // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:368:20: ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] rewrite_tree_atom EOA[\"EOA\"] ) EOB[\"EOB\"] )
                        {
                        CommonTree root_2 = (CommonTree)adaptor.nil();
                        root_2 = (CommonTree)adaptor.becomeRoot((CommonTree)adaptor.create(BLOCK, "BLOCK"), root_2);

                        // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:368:37: ^( ALT[\"ALT\"] rewrite_tree_atom EOA[\"EOA\"] )
                        {
                        CommonTree root_3 = (CommonTree)adaptor.nil();
                        root_3 = (CommonTree)adaptor.becomeRoot((CommonTree)adaptor.create(ALT, "ALT"), root_3);
                    ...
                    break;
                case 3 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:369:6: rewrite_tree ( ebnfSuffix -> ^( ebnfSuffix ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] rewrite_tree EOA[\"EOA\"] ) EOB[\"EOB\"] ) ) | -> rewrite_tree )
                    {
                    ...
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:370:3: ( ebnfSuffix -> ^( ebnfSuffix ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] rewrite_tree EOA[\"EOA\"] ) EOB[\"EOB\"] ) ) | -> rewrite_tree )
                    int alt66=2;
                    ...
                    switch (alt66) {
                        case 1 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:370:5: ebnfSuffix
                            {
                            ...
                            {
                                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:371:7: ^( ebnfSuffix ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] rewrite_tree EOA[\"EOA\"] ) EOB[\"EOB\"] ) )
                                {
                                CommonTree root_1 = (CommonTree)adaptor.nil();
                                root_1 = (CommonTree)adaptor.becomeRoot(stream_ebnfSuffix.nextNode(), root_1);

                                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:371:20: ^( BLOCK[\"BLOCK\"] ^( ALT[\"ALT\"] rewrite_tree EOA[\"EOA\"] ) EOB[\"EOB\"] )
                                {
                                CommonTree root_2 = (CommonTree)adaptor.nil();
                                root_2 = (CommonTree)adaptor.becomeRoot((CommonTree)adaptor.create(BLOCK, "BLOCK"), root_2);

                                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:371:37: ^( ALT[\"ALT\"] rewrite_tree EOA[\"EOA\"] )
                                {
                                CommonTree root_3 = (CommonTree)adaptor.nil();
                                root_3 = (CommonTree)adaptor.becomeRoot((CommonTree)adaptor.create(ALT, "ALT"), root_3);
                            ...
                            break;
                        case 2 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:372:5: 
                            {
                    ...
                    break;
                case 4 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:374:6: rewrite_tree_ebnf
                    {
                    root_0 = (CommonTree)adaptor.nil();
    ...
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:377:1: rewrite_tree_atom : ( CHAR_LITERAL | TOKEN_REF ( ARG_ACTION )? -> ^( TOKEN_REF ( ARG_ACTION )? ) | RULE_REF | STRING_LITERAL | d= '$' id -> LABEL[$d,$id.text] | ACTION );
    public final ANTLRv3Parser.rewrite_tree_atom_return rewrite_tree_atom() throws RecognitionException {
        ...
        RewriteRuleSubtreeStream stream_id=new RewriteRuleSubtreeStream(adaptor,"rule id");
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:378:5: ( CHAR_LITERAL | TOKEN_REF ( ARG_ACTION )? -> ^( TOKEN_REF ( ARG_ACTION )? ) | RULE_REF | STRING_LITERAL | d= '$' id -> LABEL[$d,$id.text] | ACTION )
            int alt69=6;
            switch ( input.LA(1) ) {
            case CHAR_LITERAL:
                {
            ...
            switch (alt69) {
                case 1 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:378:9: CHAR_LITERAL
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:379:6: TOKEN_REF ( ARG_ACTION )?
                    {
                    ...
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:379:16: ( ARG_ACTION )?
                    int alt68=2;
                    ...
                    {
                        // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:379:31: ^( TOKEN_REF ( ARG_ACTION )? )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                        root_1 = (CommonTree)adaptor.becomeRoot(stream_TOKEN_REF.nextNode(), root_1);

                        // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:379:43: ( ARG_ACTION )?
                    ...
                    break;
                case 3 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:380:9: RULE_REF
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 4 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:381:6: STRING_LITERAL
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 5 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:382:6: d= '$' id
                    {
                    ...
                    break;
                case 6 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:383:4: ACTION
                    {
                    root_0 = (CommonTree)adaptor.nil();
    ...
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:386:1: rewrite_tree_ebnf : rewrite_tree_block ebnfSuffix -> ^( ebnfSuffix rewrite_tree_block ) ;
    public final ANTLRv3Parser.rewrite_tree_ebnf_return rewrite_tree_ebnf() throws RecognitionException {
        ...
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:394:2: ( rewrite_tree_block ebnfSuffix -> ^( ebnfSuffix rewrite_tree_block ) )
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:394:4: rewrite_tree_block ebnfSuffix
            {
            ...
            {
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:394:37: ^( ebnfSuffix rewrite_tree_block )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
                root_1 = (CommonTree)adaptor.becomeRoot(stream_ebnfSuffix.nextNode(), root_1);
    ...
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:397:1: rewrite_tree : '^(' rewrite_tree_atom ( rewrite_tree_element )* ')' -> ^( TREE_BEGIN rewrite_tree_atom ( rewrite_tree_element )* ) ;
    public final ANTLRv3Parser.rewrite_tree_return rewrite_tree() throws RecognitionException {
        ...
        RewriteRuleSubtreeStream stream_rewrite_tree_atom=new RewriteRuleSubtreeStream(adaptor,"rule rewrite_tree_atom");
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:398:2: ( '^(' rewrite_tree_atom ( rewrite_tree_element )* ')' -> ^( TREE_BEGIN rewrite_tree_atom ( rewrite_tree_element )* ) )
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:398:4: '^(' rewrite_tree_atom ( rewrite_tree_element )* ')'
            {
            ...
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:398:27: ( rewrite_tree_element )*
            loop70:
            do {
                int alt70=2;
            ...
            {
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:399:6: ^( TREE_BEGIN rewrite_tree_atom ( rewrite_tree_element )* )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
                root_1 = (CommonTree)adaptor.becomeRoot((CommonTree)adaptor.create(TREE_BEGIN, "TREE_BEGIN"), root_1);

                adaptor.addChild(root_1, stream_rewrite_tree_atom.nextTree());
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:399:37: ( rewrite_tree_element )*
                while ( stream_rewrite_tree_element.hasNext() ) {
                    adaptor.addChild(root_1, stream_rewrite_tree_element.nextTree());
    ...
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:402:1: rewrite_template : ( id lp= '(' rewrite_template_args ')' (str= DOUBLE_QUOTE_STRING_LITERAL | str= DOUBLE_ANGLE_STRING_LITERAL ) -> ^( TEMPLATE[$lp,\"TEMPLATE\"] id rewrite_template_args $str) | rewrite_template_ref | rewrite_indirect_template_head | ACTION );
    public final ANTLRv3Parser.rewrite_template_return rewrite_template() throws RecognitionException {
        ...
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:414:2: ( id lp= '(' rewrite_template_args ')' (str= DOUBLE_QUOTE_STRING_LITERAL | str= DOUBLE_ANGLE_STRING_LITERAL ) -> ^( TEMPLATE[$lp,\"TEMPLATE\"] id rewrite_template_args $str) | rewrite_template_ref | rewrite_indirect_template_head | ACTION )
            int alt72=4;
            alt72 = dfa72.predict(input);
            switch (alt72) {
                case 1 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:415:3: id lp= '(' rewrite_template_args ')' (str= DOUBLE_QUOTE_STRING_LITERAL | str= DOUBLE_ANGLE_STRING_LITERAL )
                    {
                    ...
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:416:3: (str= DOUBLE_QUOTE_STRING_LITERAL | str= DOUBLE_ANGLE_STRING_LITERAL )
                    int alt71=2;
                    ...
                    switch (alt71) {
                        case 1 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:416:5: str= DOUBLE_QUOTE_STRING_LITERAL
                            {
                            ...
                            break;
                        case 2 :
                            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:416:39: str= DOUBLE_ANGLE_STRING_LITERAL
                            {
                    ...
                    {
                        // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:417:6: ^( TEMPLATE[$lp,\"TEMPLATE\"] id rewrite_template_args $str)
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:420:3: rewrite_template_ref
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 3 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:423:3: rewrite_indirect_template_head
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 4 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:426:3: ACTION
                    {
                    root_0 = (CommonTree)adaptor.nil();
    ...
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:429:1: rewrite_template_ref : id lp= '(' rewrite_template_args ')' -> ^( TEMPLATE[$lp,\"TEMPLATE\"] id rewrite_template_args ) ;
    public final ANTLRv3Parser.rewrite_template_ref_return rewrite_template_ref() throws RecognitionException {
        ...
        RewriteRuleSubtreeStream stream_rewrite_template_args=new RewriteRuleSubtreeStream(adaptor,"rule rewrite_template_args");
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:431:2: ( id lp= '(' rewrite_template_args ')' -> ^( TEMPLATE[$lp,\"TEMPLATE\"] id rewrite_template_args ) )
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:431:4: id lp= '(' rewrite_template_args ')'
            {
            ...
            {
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:432:6: ^( TEMPLATE[$lp,\"TEMPLATE\"] id rewrite_template_args )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
                root_1 = (CommonTree)adaptor.becomeRoot((CommonTree)adaptor.create(TEMPLATE, lp, "TEMPLATE"), root_1);
    ...
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:435:1: rewrite_indirect_template_head : lp= '(' ACTION ')' '(' rewrite_template_args ')' -> ^( TEMPLATE[$lp,\"TEMPLATE\"] ACTION rewrite_template_args ) ;
    public final ANTLRv3Parser.rewrite_indirect_template_head_return rewrite_indirect_template_head() throws RecognitionException {
        ...
        RewriteRuleSubtreeStream stream_rewrite_template_args=new RewriteRuleSubtreeStream(adaptor,"rule rewrite_template_args");
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:437:2: (lp= '(' ACTION ')' '(' rewrite_template_args ')' -> ^( TEMPLATE[$lp,\"TEMPLATE\"] ACTION rewrite_template_args ) )
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:437:4: lp= '(' ACTION ')' '(' rewrite_template_args ')'
            {
            ...
            {
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:438:6: ^( TEMPLATE[$lp,\"TEMPLATE\"] ACTION rewrite_template_args )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
                root_1 = (CommonTree)adaptor.becomeRoot((CommonTree)adaptor.create(TEMPLATE, lp, "TEMPLATE"), root_1);
    ...
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:441:1: rewrite_template_args : ( rewrite_template_arg ( ',' rewrite_template_arg )* -> ^( ARGLIST ( rewrite_template_arg )+ ) | -> ARGLIST );
    public final ANTLRv3Parser.rewrite_template_args_return rewrite_template_args() throws RecognitionException {
        ...
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:442:2: ( rewrite_template_arg ( ',' rewrite_template_arg )* -> ^( ARGLIST ( rewrite_template_arg )+ ) | -> ARGLIST )
            int alt74=2;
            ...
            switch (alt74) {
                case 1 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:442:4: rewrite_template_arg ( ',' rewrite_template_arg )*
                    {
                    ...
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:442:25: ( ',' rewrite_template_arg )*
                    loop73:
                    do {
                        int alt73=2;
                        ...
                        switch (alt73) {
                    	case 1 :
                    	    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:442:26: ',' rewrite_template_arg
                    	    {
                    ...
                    {
                        // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:443:6: ^( ARGLIST ( rewrite_template_arg )+ )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:444:4: 
                    {
    ...
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:447:1: rewrite_template_arg : id '=' ACTION -> ^( ARG[$id.start] id ACTION ) ;
    public final ANTLRv3Parser.rewrite_template_arg_return rewrite_template_arg() throws RecognitionException {
        ...
        RewriteRuleSubtreeStream stream_id=new RewriteRuleSubtreeStream(adaptor,"rule id");
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:448:2: ( id '=' ACTION -> ^( ARG[$id.start] id ACTION ) )
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:448:6: id '=' ACTION
            {
            ...
            {
                // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:448:23: ^( ARG[$id.start] id ACTION )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
    ...
    // $ANTLR start "id"
    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:451:1: id : ( TOKEN_REF -> ID[$TOKEN_REF] | RULE_REF -> ID[$RULE_REF] );
    public final ANTLRv3Parser.id_return id() throws RecognitionException {
        ...
        try {
            // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:451:4: ( TOKEN_REF -> ID[$TOKEN_REF] | RULE_REF -> ID[$RULE_REF] )
            int alt75=2;
            ...
            switch (alt75) {
                case 1 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:451:6: TOKEN_REF
                    {
                    ...
                    break;
                case 2 :
                    // back-end/koopa/trees/antlr/filter/generator/ANTLRv3.g:452:4: RULE_REF
                    {
    ...
    static final String[] DFA64_transitionS = {
            ...
            "",
            "",
            "\1\5\4\uffff\1\12\3\5\3\uffff\1\13\40\uffff\1\5\1\uffff\1"+
            "\11\10\uffff\1\5",
